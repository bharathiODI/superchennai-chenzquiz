...
// import React from 'react'
// import { VeniceCanvas } from './VeniceScene' // Neenga save panna path-ku etha mathri import pannikonga
...
//   return (
//     <section className="relative w-full py-16 px-4 bg-gradient-to-b from-[#f3f0ff] via-[#f7f5ff] to-[#e8e3ff] overflow-hidden howitworkssectionbg">
//       {/* 🌊 3D Venice GLB Model Background Integration */}
//       <VeniceCanvas />
...
//             <div className="h-full bg-white/80 backdrop-blur-md rounded-[28px] p-8 border border-white/60 shadow-xl shadow-purple-500/5 flex flex-col items-center text-center relative transition-all duration-300 hover:-translate-y-1 hover:shadow-purple-500/10">
//               {/* Step Number Tag */}
//               <div className="absolute rounded-[50%] top-4 left-4 bg-[#eeeaff] text-[#5122f2] text-xs font-black px-3 py-3 rounded-full">
//                 {step.stepNumber}
//               </div>
...
//               {/* Content */}
//               <h3 className="text-xl font-bold text-[#111827] mb-3">{step.title}</h3>
//               <p className="text-gray-600 text-xs sm:text-sm leading-relaxed paragraphfont">
//                 {step.description}
//               </p>
//             </div>
//           </div>
